package dev.evertonsavio.app.brewery.web.mappers;

import dev.evertonsavio.app.brewery.domain.BeerOrder;
import dev.evertonsavio.app.brewery.domain.BeerOrder.BeerOrderBuilder;
import dev.evertonsavio.app.brewery.domain.BeerOrderLine;
import dev.evertonsavio.app.brewery.web.model.BeerOrderDto;
import dev.evertonsavio.app.brewery.web.model.BeerOrderDto.BeerOrderDtoBuilder;
import dev.evertonsavio.app.brewery.web.model.BeerOrderLineDto;
import dev.evertonsavio.app.brewery.web.model.BeerOrderLineDto.BeerOrderLineDtoBuilder;
import dev.evertonsavio.app.brewery.web.model.OrderStatusEnum;
...
@Generated(
    ...
    date = "2021-09-15T15:47:12-0300",
    comments = "version: 1.3.0.Final, compiler: javac, environment: Java 11.0.9.1 (Debian)"
)
@Component
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum(dev.evertonsavio.app.brewery.domain.OrderStatusEnum orderStatusEnum) {
    ...
    protected dev.evertonsavio.app.brewery.domain.OrderStatusEnum orderStatusEnumToOrderStatusEnum1(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        dev.evertonsavio.app.brewery.domain.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = dev.evertonsavio.app.brewery.domain.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = dev.evertonsavio.app.brewery.domain.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = dev.evertonsavio.app.brewery.domain.OrderStatusEnum.PICKED_UP;
            break;
            default: throw new IllegalArgumentException( "Unexpected enum constant: " + orderStatusEnum );
        }
